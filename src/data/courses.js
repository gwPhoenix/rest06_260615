export const GRADS = {
  wave: 'linear-gradient(135deg,#2D5BFF,#14D6D6)',
  purp: 'linear-gradient(135deg,#7B40F2,#2D5BFF)',
  ink:  'linear-gradient(135deg,#0A0E1F,#1B36C9)',
  lime: 'linear-gradient(135deg,#14D6D6,#C8FF3D)',
  pink: 'linear-gradient(135deg,#FF5DA2,#7B40F2)',
  cyan: 'linear-gradient(135deg,#14D6D6,#2D5BFF)',
}
...
export const COURSES = [
  ...
  { id:'ai',       cat:'코딩',     title:'AI · 데이터 사이언스',     sub:'Python · 머신러닝 · LLM',           level:'초중급',    weeks:20, lessons:132, rating:4.8, students:5400,  price:890000,  was:1390000, grad:GRADS.purp, icon:'🤖',  best:false, tagClass:'chip-purple', tag:'HOT' },
  { id:'jeongcheo',cat:'자격증',   title:'정보처리기사 완성반',       sub:'필기+실기 한 번에 합격',             level:'자격증',    weeks:12, lessons:96,  rating:4.9, students:11200, price:240000,  was:390000,  grad:GRADS.cyan, icon:'✓',   best:false, tagClass:'chip-cyan',   tag:'합격보장' },
  { id:'be',       cat:'코딩',     title:'백엔드 개발 마스터',        sub:'Java · Spring · 클라우드',          level:'중급',      weeks:22, lessons:140, rating:4.8, students:4100,  price:850000,  was:1290000, grad:GRADS.ink,  icon:'⚙',   best:false, tagClass:'chip-blue',   tag:'NEW' },
  { id:'sqld',     cat:'자격증',   title:'SQLD 단기 합격반',          sub:'데이터 모델링 · SQL 활용',           level:'자격증',    weeks:6,  lessons:48,  rating:4.7, students:6800,  price:180000,  was:290000,  grad:GRADS.wave, icon:'🗄',  best:false, tagClass:'chip-cyan',   tag:'합격보장' },
  { id:'excel',    cat:'컴퓨터활용', title:'실무 엑셀 & 데이터 분석', sub:'함수 · 피벗 · 대시보드 · 자동화',  level:'입문',      weeks:8,  lessons:64,  rating:4.9, students:9300,  price:150000,  was:240000,  grad:GRADS.lime, icon:'📊',  best:false, tagClass:'chip-lime',   tag:'BEST' },
  { id:'comphwal', cat:'컴퓨터활용', title:'컴퓨터활용능력 1급',      sub:'필기+실기 자격증 완전정복',          level:'자격증',    weeks:8,  lessons:72,  rating:4.8, students:7600,  price:130000,  was:220000,  grad:GRADS.cyan, icon:'⌨',   best:false, tagClass:'chip-cyan',   tag:'합격보장' },
  { id:'cloud',    cat:'코딩',     title:'클라우드 & DevOps',         sub:'AWS · Docker · CI/CD',              level:'중상급',    weeks:16, lessons:104, rating:4.7, students:2900,  price:790000,  was:1190000, grad:GRADS.purp, icon:'☁',   best:false, tagClass:'chip-purple', tag:'심화' },
  { id:'ux',       cat:'코딩',     title:'UX 엔지니어링',             sub:'디자인 시스템 · 인터랙션',           level:'중급',      weeks:14, lessons:88,  rating:4.8, students:3300,  price:690000,  was:990000,  grad:GRADS.pink, icon:'✦',   best:false, tagClass:'chip-purple', tag:'NEW' },
]
